const createURL = (path: string) => {
    return typeof window === 'undefined' ? "http://localhost:3000" + path : window.location.origin + path;
};
...
export const getOneGymData = async (gymName: string): Promise<GymInfoType[]> => {
